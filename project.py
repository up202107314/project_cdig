...
class project(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._gain_range = qtgui.Range(0, 60, 1, 1, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/guilherme/curso/mestrado/CDIG/teste.pcap', False)
        ...
        self.connect((self.blocks_delay_0, 0), (self.ieee802_11_sync_short_1, 0))
        self.connect((self.blocks_delay_0_0, 0), (self.ieee802_11_sync_long_0, 1))
        self.connect((self.blocks_divide_xx_0, 0), (self.ieee802_11_sync_short_1, 2))
        ...
        self.connect((self.fir_filter_xxx_0_0, 0), (self.ieee802_11_sync_short_1, 1))
        self.connect((self.foo_wireshark_connector_1, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.ieee802_11_frame_equalizer_0, 0), (self.ieee802_11_decode_mac_0, 0))
        self.connect((self.ieee802_11_sync_long_0, 0), (self.blocks_stream_to_vector_0, 0))
        self.connect((self.ieee802_11_sync_short_1, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.ieee802_11_sync_short_1, 0), (self.ieee802_11_sync_long_0, 0))
